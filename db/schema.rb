...
ActiveRecord::Schema.define(version: 2020_09_01_035236) do
  ...
  create_table "buy_histories", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["good_id"], name: "index_buy_histories_on_good_id"
  ...
  create_table "buyers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buy_history_id"], name: "index_buyers_on_buy_history_id"
  end
  ...
  add_foreign_key "buyers", "buy_histories"
