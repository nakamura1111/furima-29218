module BuySupport
  ...
  def create_buy
    ...
    #   postal_code: @buy_info.postal_code, addr_prefecture_id: @buy_info.addr_prefecture_id,
    #   addr_municipality: @buy_info.addr_municipality, addr_house_number: @buy_info.addr_house_number,
    #   addr_building: @buy_info.addr_building, tel_number: @buy_info.tel_number,
